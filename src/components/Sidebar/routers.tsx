import { FaGear, FaHouse, FaNewspaper, FaPerson, FaTable, FaUsers } from "react-icons/fa6";
    ...
    menuItems: [
      ...
      // },
      {
        ...
        children: [
          ...
          { label: "List Users", route: "/admin/users" },
        ],
      },
      {
        icon: <FaNewspaper />,
        ...
        route: "",
        children: [
          { label: "New Blog", route: "/admin/blogs/new" },
          { label: "List Blogs", route: "/admin/blogs" },
        ],
      },
      {
        icon: <FaPerson />,
